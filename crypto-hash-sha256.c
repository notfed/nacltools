...
static stralloc m = {0};
static stralloc h = {0};
#define FATAL "crypto-hash-sha256: error: "
...
int main(int argc, char * argv[])
{
    ...
    if(argc>2 || ( argc==2 && str_diff(argv[1],"-b"))) 
        strerr_die1x(111,"crypto-hash-sha256: usage: crypto-hash-sha256 [-b] < message");
    ...
    /* Hash message */
    if(crypto_str_hash_sha256(&h,&m)!=0) 
