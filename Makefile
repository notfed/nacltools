...
zeros.o : compile zeros.c
	./compile zeros.c
it : crypto-box crypto-box-keypair crypto-box-open crypto-secretbox crypto-secretbox-key crypto-secretbox-open nacl-key-decode nacl-key-encode zerocheck zeros
clean : 
	rm -f *.o crypto-box crypto-box-keypair crypto-box-open crypto-secretbox crypto-secretbox-key crypto-secretbox-open nacl-key-decode nacl-key-encode zerocheck zeros
